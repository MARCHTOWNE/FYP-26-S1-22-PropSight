...
model_training.py       → Train/tune/evaluate models and save ML artefacts
...
Latest run:
- Run directory: `model_assets/20260306_135538/`
...
- `model_assets/latest.txt` points to the currently active run.
...
Generated by `feature_engineering.py` and updated by `model_training.py`:
